****************** Copyright Notice ********************************
IMPACT-Z  v 1.0 Copyright (c) 2008, The Regents of the University of 
...
INTRODUCTION
------------
IMPACT-Z is a 3D parallel/serial Particle-In-Cell (PIC) code based on multi-layer object-oriented design.
...
To run the IMPACT code, the user needs to prepare the input files.
This will involve to use Rfcoef code to get Fourier expansion coefficients and to Theta code to set up the initial driven phase for rf cavities.

The IMPACT has been used to model the Spallation Neutron
...
3.97e-10 4.01e-10 4.06e-10 4.10e-10 (q_i/m_i for each charge state. Here, we normalized each charge
                                     ...
                                     has 1 AMU mass, but less charge.)
...
-----------------------------------------------------------
402.5e6 88.e6 939.294e6 0.0 -1.0 2 0 0 7 88.78 0.001 0.03 75.0 0.001 0.02
